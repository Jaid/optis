...
export type ToSetupFromInput<InputGeneric> = [InputGeneric] extends [undefined] ? {} : InputGeneric extends Dict ? HasSetupKey<InputGeneric> extends true ? NormalizeSetup<{
    defaults: InputGeneric extends {
        defaults: infer DefaultsGeneric extends Dict;
    } ? DefaultsGeneric : {};
...
export type ExtractSetup<InputGeneric> = InputGeneric extends {
...
type NormalizationsOf<SetupGeneric extends Setup> = SetupGeneric extends {
    normalizations: infer NormalizationsGeneric extends Dict;
